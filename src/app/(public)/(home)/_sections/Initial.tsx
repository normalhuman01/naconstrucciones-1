  ...
  return (
    <div>
      <Carousel responsive={responsive} ssr infinite autoPlay>
        <div
          className="relative flex flex-col items-center justify-center text-white text-center h-[438px]"
          style={{ backgroundImage: "url(/img/home/REMODELACION.jpg)" }}
        >
          ...
          <ButtonBlack className="text-[15px] z-10">CONSULTAR</ButtonBlack>
        </div>
        ...
        >
          <div className="absolute top-0 left-0 w-full h-full bg-[rgba(0,0,0,.2)]"></div>
          <span className="z-10">Especialidad</span>
          <h2 className="z-10 text-[60px]">REMODELACIÓN</h2>
          <p className="z-10">
            Creamos desde cero con visión <br /> y precisión técnica
          </p>
          <ButtonBlack className="text-[15px] z-10">CONSULTAR</ButtonBlack>
