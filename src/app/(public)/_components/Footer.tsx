    ...
    <footer className="bg-[#2F2F2F] text-white overflow-hidden">
      <div className="max-w-[1120px] mx-auto flex flex-col items-center py-3">
        <img
          ...
          className="mt-3 mb-7"
        />
        <div className="w-full flex flex-col md:flex-row items-center md:items-stretch flex-wrap justify-around text-[12px] text-center font-light">
          ...
          <div className="hidden md:flex flex-col items-center w-[160px] md:w-[320px]">
            <img
            ...
            <span className={cn("text-[19px] font-light leading-none mt-1", calibriFont.className)}>{config.address}</span>
          </div>
          <div className="flex flex-col items-center w-[160px] md:w-[320px]">
            <img
          ...
          <div className="flex md:hidden flex-col items-center max-w-[90%] md:w-[320px]">
            <img
              src="/img/icons/mark.png"
              width={28}
              height={28}
